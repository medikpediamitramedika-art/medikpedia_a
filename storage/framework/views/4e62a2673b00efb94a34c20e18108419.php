    ...
    <div class="admin-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="<?php echo e(route('admin.promo-products.index')); ?>" class="<?php if(str_contains(Route::current()->getName() ?? '', 'admin.promo-products')): ?> active <?php endif; ?>">
                        <span>🏷️</span>
...
<?php /**PATH C:\Users\Ali Attaziri\medikpedia_a-main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>