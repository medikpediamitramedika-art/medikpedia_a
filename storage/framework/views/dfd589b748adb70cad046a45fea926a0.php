...
<?php $__env->startSection('title', 'Medikpedia - Apotik Online Terpercaya'); ?>
...
<div class="banner-slider" id="bannerSlider" style="width: 100%; height: 100%; aspect-ratio: 3998/1224;">
    <div class="banner-track" id="bannerTrack" style="display: flex; width: 100%; height: 100%;">
        ...
        <div class="banner-slide <?php echo e($i === 0 ? 'active' : ''); ?>" data-index="<?php echo e($i); ?>" style="min-width: 100%; width: 100%; height: 100%;">
            <a href="<?php echo e($banner->url_tujuan ?: '#'); ?>" class="banner-link" style="display: block; width: 100%; height: 100%;" <?php echo e($banner->url_tujuan ? 'target=_blank' : ''); ?>>
                <img src="<?php echo e(url('storage/'.$banner->gambar)); ?>" alt="<?php echo e($banner->judul); ?>" class="banner-img" loading="<?php echo e($i === 0 ? 'eager' : 'lazy'); ?>">
                <div class="banner-overlay">
                    <div class="banner-text">
                        <h2 class="banner-title-text"><?php echo e($banner->judul); ?></h2>
                        <?php if($banner->subjudul): ?>
                        <p class="banner-sub-text"><?php echo e($banner->subjudul); ?></p>
                        <?php endif; ?>
                        <?php if($banner->url_tujuan): ?>
                        <span class="banner-btn-label"><?php echo e($banner->label_tombol); ?> <i class="fa-solid fa-arrow-right"></i></span>
                        <?php endif; ?>
                    </div>
                </div>
            </a>
    ...
    <div class="banner-dots">
        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <button class="banner-dot <?php echo e($i === 0 ? 'active' : ''); ?>" onclick="goToBanner(<?php echo e($i); ?>)" aria-label="Slide <?php echo e($i+1); ?>"></button>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    <?php endif; ?>
</div>
...
<div class="quick-section">
  <div class="container">
    <div class="quick-row">
      <a href="<?php echo e(route('products.index')); ?>" class="quick-btn active"><i class="fa-solid fa-th-large"></i><span>Semua</span></a>
      <a href="<?php echo e(route('products.pbf')); ?>" class="quick-btn"><i class="fa-solid fa-box" style="color:#f59e0b;"></i><span>PBF</span></a>
      <a href="<?php echo e(route('products.apotek')); ?>" class="quick-btn"><i class="fa-solid fa-store" style="color:#059669;"></i><span>Apotek</span></a>
      <a href="<?php echo e(route('products.index')); ?>?kategori_produk=OBAT" class="quick-btn"><i class="fa-solid fa-pills" style="color:#1E88E5;"></i><span>Obat</span></a>
      <a href="<?php echo e(route('products.index')); ?>?kategori_produk=SKINCARE+%26+KOSMETIK" class="quick-btn"><i class="fa-solid fa-spa" style="color:#e91e8c;"></i><span>Skincare</span></a>
      <a href="<?php echo e(route('products.index')); ?>?kategori_produk=ALAT+KESEHATAN" class="quick-btn"><i class="fa-solid fa-stethoscope" style="color:#0288d1;"></i><span>ALKES</span></a>
    </div>
  </div>
</div>
...
<div class="promo-section">
  <div class="container">
    <div class="promo-grid">
      <a href="<?php echo e(route('contact')); ?>" class="promo-card promo-contact">
      ...
      <a href="https://store.goapotik.com/penjual/apotek-medikpedia" target="_blank" rel="noopener" class="promo-card promo-goapotik">
        <img src="<?php echo e(asset('LOGO GOAPOTIK.png')); ?>" alt="GoApotik" class="promo-goapotik-logo">
...
<?php echo $__env->make('components.category-selection', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<section class="featured-section">
  <div class="container">
    ...
    <div class="featured-track-wrap" id="featWrap">
      <div class="featured-track" id="featTrack">
        ...
        <div class="prod-card">
          <div class="prod-img">
            <?php if($med->gambar): ?>
              <img src="<?php echo e(url('storage/'.$med->gambar)); ?>" alt="<?php echo e($med->nama_obat); ?>" loading="lazy">
            <?php else: ?>
          ...
          <div class="prod-body">
            <?php if($med->kategori): ?><span class="prod-brand-tag"><?php echo e($med->kategori); ?></span><?php endif; ?>
            ...
            <?php if($med->stok > 0): ?>
            <button class="btn-cart" onclick="addToCart(<?php echo e($med->id); ?>,'<?php echo e(addslashes($med->nama_obat)); ?>',<?php echo e($med->harga); ?>,'<?php echo e($med->gambar ? url('storage/'.$med->gambar) : ''); ?>',this)">
    ...
    <div class="featured-cta">
      <a href="<?php echo e(route('products.index')); ?>" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.7rem 2.25rem;background:linear-gradient(135deg,#1E88E5,#1565C0);color:#fff;border-radius:50px;text-decoration:none;font-weight:700;font-size:0.9rem;transition:all 0.25s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform=''">
...
<div class="about-strip">
  <div class="container">
    <div class="about-box">
      <img src="<?php echo e(asset('logo1.png')); ?>" alt="Medikpedia" class="about-logo">
      ...
      <div class="prod-grid" style="grid-template-columns:repeat(auto-fill,minmax(220px,1fr)); gap:1rem;">
        ...
        <?php $__currentLoopData = $allProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $med): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="prod-card">
            ...
            <div class="prod-body">
              <?php if($med->kategori): ?>
                <span class="prod-brand-tag"><?php echo e($med->kategori); ?></span>
              <?php endif; ?>
              <h3 class="prod-name"><?php echo e($med->nama_obat); ?></h3>
              <div class="prod-price"><?php echo e($med->getFormattedPrice()); ?></div>
              <?php if($med->stok > 0): ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medikpedia_a-main\resources\views/home.blade.php ENDPATH**/ ?>