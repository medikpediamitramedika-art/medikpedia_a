<?php $__env->startSection('title', 'Tambah Banner - Admin Medikpedia'); ?>
<?php $__env->startSection('page-title', '🖼️ Tambah Banner Promo'); ?>
...
<div class="form-card">
    ...
    <form action="<?php echo e(route('admin.banners.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="judul" class="form-control" placeholder="Contoh: Promo Ramadan 50%" value="<?php echo e(old('judul')); ?>" required <?php if(isset($bannerTableReady) && !$bannerTableReady): echo 'disabled'; endif; ?>>
        </div>

        <div class="form-group">
            <label class="form-label">Subjudul / Deskripsi Singkat</label>
            <input type="text" name="subjudul" class="form-control" placeholder="Contoh: Dapatkan diskon besar untuk semua produk vitamin" value="<?php echo e(old('subjudul')); ?>" <?php if(isset($bannerTableReady) && !$bannerTableReady): echo 'disabled'; endif; ?>>
        </div>

        <div class="form-group">
            <label class="form-label">Gambar Banner <span class="req">*</span></label>
            <input type="file" name="gambar" id="gambarInput" accept="image/*" class="form-control" onchange="previewImg(this)" required <?php if(isset($bannerTableReady) && !$bannerTableReady): echo 'disabled'; endif; ?>>
        ...
        <div class="form-row">
            ...
            <div class="form-group" style="margin-bottom:0;">
                ...
                <input type="text" name="label_tombol" class="form-control" placeholder="Lihat Sekarang" value="<?php echo e(old('label_tombol', 'Lihat Sekarang')); ?>" <?php if(isset($bannerTableReady) && !$bannerTableReady): echo 'disabled'; endif; ?>>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Ali Attaziri\medikpedia_a-main\resources\views/admin/banners/create.blade.php ENDPATH**/ ?>